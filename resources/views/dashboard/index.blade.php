        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            @if($user->avatar)
                <div class="mt-2 flex justify-center">
                    <img src="{{asset('storage/' . $user->avatar)}}" alt="{{$user->name}}" class="w-32 h-32
            ...
            <form method="POST" action="{{route('profile.update')}}" enctype="multipart/form-data">
                ...
                <button class="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 border
                ...
                <div class="mt-4 bg-gray-100 p-2">
                    ...
                    @forelse($job->applicants as $applicant)
                        <div class="py-2">
                            ...
                            <p class="text-gray-800">
                                <strong>Phone: </strong> {{$applicant->contact_phome}}
                            </p>
                            <p class="text-gray-800">
                            ...
                            <p class="text-gray-800 my-4">
                                <a href="{{asset('storage/' . $applicant->resume_path)}}"
                                   class="text-blue-500 hover:underline text-sm" download=""> <i class="fas fa-download"></i>
                                Download Resume</a>
                            </p>
                    ...
                    @empty
                        <p class="text-gray-700 mb-4">Np applicants for this job</p>
                    @endforelse
                </div>
            @empty
