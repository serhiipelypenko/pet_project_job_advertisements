<x-layout>
    <div class="bg-white rounded-lg shadow-md w-full :max-w-xl mx-auto mt-12 p-8 py-12">
        ...
        <form method="POST" action="{{route('login.authenticate')}}">
            ...
            <button type="submit" class="w-full bg-blue-500 text-white px-4 py-2 rounded focus:outline-none">
                Login
            </button>
